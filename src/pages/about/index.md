...
当前版本为 **v0.8.5-beta**，包名 [`dsh-liangxiang`](https://www.npmjs.com/package/dsh-liangxiang)。官网推荐 `dsh-liangxiang@beta`；固定版本安装包以插件仓库 Releases 为准。

<h2 id="principles">设计原则</h2>

### 现代编年志 × 克制梁祠

界面以现代桌面产品为底：清晰层级、稳定信息密度与克制的中性色。日历、编年与少量朱印提供识别，暖金和朱红用于重点标记。
